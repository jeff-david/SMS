            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @if (Session::has('failed'))
                        ...
                        <form action="{{route('admin.register_student')}}" method="post" novalidate="novalidate">
                        @csrf
                            <div class="card-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-success">
                                            <label for="motherName" class="control-label mb-1"><small>Mother's Maiden
                                                    Name</small></label>
                                            <input id="motherName" name="mother_name" type="text" class="form-control" value="{{old('mother_name')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            <label for="glname" class="control-label mb-1"><small>Last
                                                    Name</small></label>
                                            <input id="guardian_lastname" name="guardian_lastname" type="text" class="form-control" value="{{old('guardian_lastname')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            <label for="gfname" class="control-label mb-1"><small>First
                                                    Name</small></label>
                                            <input id="gfname" name="guardian_firstname" type="text" class="form-control" value="{{old('guardian_firstname')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            <label for="gmname" class="control-label mb-1"><small>Middle
                                                    Name</small></label>
                                            <input id="gmname" name="guardian_middlename" type="text" class="form-control" value="{{old('guardian_middlename')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group has-success">
                                            <label for="relation" class="control-label mb-1"><small>Relatioship to the
                                                    student</small></label>
                                            <input id="relation" name="rel_student" type="text" class="form-control" value="{{old('rel_student')}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="address" name="current_res" type="text" class="form-control" value="{{old('current_res')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="guardian_rel" name="guardian_rel" type="text" class="form-control" value="{{old('guardian_rel')}}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            <label for="cel1" class="control-label mb-1"><small>Mother
                                                    Tongue</small></label>
                                            <input id="mother_tounge" name="mother_tounge" type="text" class="form-control" value="{{old('mother_tounge')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="eth" name="ethnicities" type="text" class="form-control" value="{{old('ethnicities')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="cel1" name="cell_1" type="text" class="form-control" value="{{old('cell_1')}}">
