...
<div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid" style="margin-top: 22px;">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#sendconcern">Send Concern</button>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-subtitle mb-2 text-muted"><small>Brayan Yagonia's Brother</small></h5>
                                        ...
                                        <br>
                                        <button class="btn btn-primary"  data-toggle="modal" data-target="#replyconcern">Reply</button>
